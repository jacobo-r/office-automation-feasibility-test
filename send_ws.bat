...
"C:\Users\Administrador\AppData\Local\Programs\Python\Python314\python.exe" ^
  "D:\USUARIOS (NO BORRAR)\ADMINISTRADOR\Downloads\office-automation-feasibility-test-main\ws_send_pdf.py" ^
  ws://127.0.0.1:9000 ^
  "D:\USUARIOS (NO BORRAR)\ADMINISTRADOR\Downloads\office-automation-feasibility-test-main\temp_pdf" ^
  >> "D:\USUARIOS (NO BORRAR)\ADMINISTRADOR\Downloads\office-automation-feasibility-test-main\ws_send_log_from_macro.txt" 2>&1
